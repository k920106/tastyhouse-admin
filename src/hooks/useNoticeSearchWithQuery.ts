...
import { useNoticesQuery } from './queries/useNoticeQueries'
...
export interface NoticeSearchHookResult {
  // 로딩 상태
  loading: boolean
...
export const useNoticeSearchWithQuery = (): NoticeSearchHookResult => {
  ...
  const updateUrl = useCallback(
    (form: NoticeSearchForm, page: number = 0, size: number = pageSize) => {
